...
fun main(){
    ...
    //TODO: 유저 정보 할당
    userInfoInput(readln(), readln().toInt())
...
private fun userInfoInput(userName: String, userAge: Int){
    //TODO: 유저 정보 할당
    println()
    println("유저 정보를 입력하세요")
    print("이름 : ")
    var userName : String // TODO: 이름 입력
    print("나이 : ")
    var userAge : Int // TODO: 나이 입력(정수로)
}
...
private fun userInfoPrint(user: MutableMap<String, Any>) {
    //TODO: 플레이어 정보 출력
    println("==========플레이어 정보==========")
    println("이름 : ${user["이름"]}")
    println("나이 : ${user["나이"]}")
...
//private fun userInfoPrint(user) : String{
